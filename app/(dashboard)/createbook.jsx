...
const CreateBook = () => {
  ...
  return (
    ...
    <Spacer/>
    <ThemedText title={true} style = {styles.title}>Add Book</ThemedText>

    <ThemedTextInput placeholder = {"Title"} style = {styles.input}
    onChangeText = {setTitle}
    value = {title}></ThemedTextInput>

    <Spacer height = {30}/>
    <ThemedTextInput placeholder = {"Author"} style = {styles.input}
